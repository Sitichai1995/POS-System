    ...
    <div class="card mt-4 shadow-md">
        ...
        <div class="card-body">
                        ...
                        <table style="width: 100%; margin-bottom: 20px;">
                            <tr>
                                ...
                                <td align="end">
                                    ...
                                    <p style="font-size: 14px; line-height: 20px; margin: 0px; padding: 0;">Invoice No: <?= $rowData['invoice_no']; ?></p>
            ...
            <div class="mt-4 text-end">
                ...
                <button class="btn btn-warning px-4 mx-1" onclick="downloadPDF('<?= $rowData['invoice_no']; ?>')">Download PDF</button>
            </div>
